...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function scenarios()
    {
        ...
        return ArrayHelper::merge($scenarios, [
            'register' => ['username', 'email', 'password','prov','tel','mobile'],
            'connect'  => ['username', 'email'],
            'create'   => ['username', 'email', 'password','prov','tel','mobile','prename','fname','lname','position','position_level','position_type','hcode'],
            'update'   => ['username', 'email', 'password','prov','tel','mobile'],
    ...
    public function rules()
    {
        return [
            // username rules
            'usernameRequired' => [['username','prename','fname','lname','position','hcode','personid'], 'required', 'on' => ['register', 'create', 'connect', 'update']],
            'usernameMatch'    => ['username', 'match', 'pattern' => static::$usernameRegexp],
            'usernameLength'   => ['username', 'string', 'min' => 3, 'max' => 255],
            'usernameUnique'   => ['username', 'unique', 'message' => Yii::t('user', 'This username has already been taken')],
            'usernameTrim'     => ['username', 'trim'],
            'telTrim'     => [['tel','mobile','position_type','position_level'], 'trim'],
